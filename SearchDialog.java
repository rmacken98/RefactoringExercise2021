...
public class SearchDialog extends JDialog implements ActionListener {
    ...
    public Container searchPane(String field) {
        JPanel searchPanel = new JPanel(new GridLayout(3, 1));
        JPanel textPanel = new JPanel();
        JPanel buttonPanel = new JPanel();
        JLabel searchLabel;
        searchPanel.add(new JLabel("Search by " + field));

        textPanel.setBorder(BorderFactory.createEtchedBorder(EtchedBorder.LOWERED));
        textPanel.add(searchLabel = new JLabel("Enter " + field + ":"));
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        if (e.getSource() == search && type.equalsIgnoreCase("ID")) {
        ...
        else if (e.getSource() == search && type.equalsIgnoreCase("Surname")) {
